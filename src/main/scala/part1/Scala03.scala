object Scala03 extends App {
  ...
  def makeUpper(s: String) : String = {
    myStr.toUpperCase
  }

  def prinWorkedString(s: String, f: String => String) = {
    println(f(s))
  }

  prinWorkedString(myStr, makeUpper)
  prinWorkedString(myStr, x => x.toUpperCase)
